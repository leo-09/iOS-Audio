...
#define CalendarColor [UIColor colorWithRed:3.0/255.0 green:163.0/255.0 blue:214.0/255.0 alpha:1.0]
...
- (NSString *)chinaCalendarWithMonth:(DayModel*)model{
    ...
    NSDictionary *Holidays = @{@"01-01":@"元旦", @"02-14":@"情人节", @"03-08":@"妇女节",
                               @"03-12":@"植树节", @"05-01":@"劳动节", @"05-04":@"青年节",
                               @"06-01":@"儿童节", @"07-01":@"建党节", @"08-01":@"建军节",
                               @"09-10":@"教师节", @"10-01":@"国庆节", @"12-24":@"平安夜",
                               @"12-25":@"圣诞节"};
