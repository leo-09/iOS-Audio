...
//    
    ...
    self.originalBtn = [UIButton buttonWithFrame:CGRectMake(140, 194, 18, 18) Target:self Selector:@selector(originalSwitch:) Image:@"SuPhoto_unselected" ImageSelected:@"SuPhoto_selected"];
