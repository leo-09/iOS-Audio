//
//  CCarSubscribeCommentStationView.m
//  AcrossAnHui
//
...
@interface CCarSubscribeCommentStationView()
...
@implementation CCarSubscribeCommentStationView
...
- (void)setStationList:(CarInspectStationModel *)stationList{
    ...
    //[self.stationImageView sd_setImageWithURL:[NSURL URLWithString:[stationList stationPic]] placeholderImage:[UIImage imageNamed:@"xiangq.png"]];
    ...
    self.addressLabel.frame = CGRectMake(140, 60, self.frame.size.width-150, 15);
