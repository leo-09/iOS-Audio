...
{
    UITableViewCell *celled = [tableView cellForRowAtIndexPath:_selectedIndexPath];
    ...
    if (indexPath.section == 0)
    {
        ...
        // [self.delegate getNewAddress:self.currentAddress];
        return ;
    }
    
    self.selectedPoi = self.searchPoiArray[indexPath.row];
    //[self.delegate getNewAddress:self.selectedPoi.name];
