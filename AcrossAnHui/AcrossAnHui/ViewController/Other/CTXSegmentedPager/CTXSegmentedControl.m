...
@interface CTXScrollView : UIScrollView
@end

@implementation CTXScrollView
...
@property (nonatomic, strong) CTXScrollView *scrollView;

@end

@implementation CTXSegmentedControl
...
- (void)commonInit {
    self.scrollView = [[CTXScrollView alloc] init];
    ...
    self.textColor = UIColorFromRGB(CTXTextBlackColor);
    self.selectedTextColor = UIColorFromRGB(CTXThemeColor);
    self.backgroundColor = [UIColor whiteColor];
    self.opaque = NO;
    self.selectionIndicatorColor = UIColorFromRGB(CTXThemeColor);
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    CTXLog(@"touchLocation.x %f",touchLocation.x);
